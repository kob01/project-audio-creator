...
function App() {
  ...
  return <div style={{ width: '100%', height: '100%', position: 'absolute', opacity: consoleFullScreen ? 0 : 1, transition: '0.5s all' }}>

    <Animation tag='div' restore={true} animation={[{ opacity: 0 }, { opacity: 1 }]} style={{ width: 'fit-content', height: 'fit-content', position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, margin: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', transition: '0.5s all' }}>
