...
function App() {
  ...
  const onClose = () => Imitation.assignState({ dialogCurrentAudioSetting: false })

  return <Dialog open={Imitation.state.dialogCurrentAudioSetting} sx={{ '& .MuiDialog-paper': { width: '100%', maxWidth: 720 } }} onClose={() => onClose()}>
